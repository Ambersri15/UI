...
public class Main_DomainProvisioningAndPublishing extends PreRequisites{
	...
	public void main(int PortNo) throws Throwable{
		...
		LOGS.info(curDate);
		TestCaseName="UI_DomainProvisioning&Publishing_"+curDate;	
		Resultsfolderpath = pr.createFolder(TestCaseName);
		pr.preparingOutputSheets();
		//SalesRepType = "TSales";
		st.portNO = PortNo;
		
		st.DomainProvisioningAndPublishing("8046830345", Resultsfolderpath);
