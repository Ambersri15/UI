...
//Day2Validations 	
	...
	public String SignType = "",LeadState="";
	 ...
	 // public String regardingfilesPath = "C://Automation//readingfiles//";//
	   public String regardingfilesPath = System.getProperty("user.dir"+"//readingfiles");
	  
	   
		//public static String ZephyrPath=regardingfilesPath+"/OutputFiles/ZephyrResults";
	   //LOGS.info("this is the readingfiles path "+regardingfilesPath);
		...
		public  Properties loadPropertiesFiles(String propFile) {
			...
			try {
				...
				//fs = PreRequisites.class.getClassLoader().getResourceAsStream("/"+/HealthCheck/src/main/resources/readingfiles/InputFiles/config.properties+".properties");
					fs = new FileInputStream(System.getProperty("user.dir")+"//readingfiles//InputFiles//"+propFile+".properties");
					p.load(fs);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		public  String createFolder(String folderpath)throws Exception{
			...
			//Resultsfolderpath=regardingfilesPath+".OutputFiles.TestResults."+TestCaseName;
			//Resultsfolderpath="/readingfiles/OutputFiles/TestResults/"+TestCaseName;
						...
						if(((row.getCell(6).getStringCellValue()).trim()).equals(TestCaseName))
						{
							LOGS.info("Iteration started");
							{
								...
								//	ExportResults.exportTestResult("Account Name fetching,"+"Äccount for Fullfimment should be avaiable" +","+BusinessName+" is available,"+"Pass"+","+"No Image");
									LOGS.info("Account,"+"Account for Fullfimment should be avaiable" +","+BusinessName+" is available,"+"Pass");
