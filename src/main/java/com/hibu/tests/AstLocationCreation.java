...
public class AstLocationCreation extends PreRequisites {

	public static Logger LOGS = LogManager.getLogger(AstLocationCreation.class.getName());
	...
	public String locationCreationStatus="Fail", locCreationStatus="Fail";
	...
	public void Assistant_LocationCreation(String BusinessId, String RepName, String Resultsfolderpath) throws Exception
	{
		...
		if(!locCreationStatus.equalsIgnoreCase("Pass")) {
			...
			ActRes = "There was some issue with Location Creation Process";
			Status = "Fail";
	...
	public String AssistantLocationCreation(String BusinessID, String Resultsfolderpath) throws Exception
	{
		...
		try {
			...
			WebDriverWait waitforContactListTable = new WebDriverWait(driver, 50);
		...
		if(TabSelected.contains("Dashboard - Hibu Testing"))
		{		
		ImageName = "SignPost";
		ImgName = ScreenshotPrinter.screenShot(ImageName, driver, Resultsfolderpath);
		ExpRes = "User Successfully Move Into SignPost Page";
